...
var fw7ModulesBeingUsed = ['accordion', 'cards', 'fast-clicks', 'forms', 'infinite-scroll', 'modals', 'pull-to-refresh', 'push-state', 'searchbar', 'smart-select', 'sortable', 'swipeout', 'swiper'];
